...
public class Levenshtein {
	 ...
	 * respecting supplementary characters (i.e., surrogate pairs). The
	 * algorithm is the two-row technique from:
	 *
	 * https://en.wikipedia.org/wiki/Levenshtein_distance
	 *
	 ...
	 * 
	 * http://www.codeproject.com/Articles/13525/Fast-memory-efficient-
	 * Levenshtein-algorithm
	 *
	 * @param stringA
	 *            the first string, must be non-null
	 * @param stringB
	 *            the second string, must be non-null
